...
# #     pickle.dump(imelda, pickle_file) # allows `imelda` to be called with a single line
#
# with open("imelda.pickle", "rb") as imelda_pickled:
#     imelda2 = pickle.load(imelda_pickled)
#
# # reading the data out of the `imelda.pickle` file into the `imelda2` object
#
# print(imelda2)
#
...
for i in even_list: # extracting all items from `even` list
    print(i)

print('=' * 40)

for i in odd_list: # extracting all items from `odd` list
    print(i)
